    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentGenres", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentGenres_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentGenres_Genre_GenreId",
                        column: x => x.GenreId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentGenres_DocumentId",
                table: "DocumentGenres",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentGenres_GenreId",
                table: "DocumentGenres",
                column: "GenreId");
